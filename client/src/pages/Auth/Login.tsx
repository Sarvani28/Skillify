  ...
  <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    >
      ...
      <input
        type="email"
        placeholder="Email"
        className="w-full mb-5 bg-transparent border-b border-gray-300/40 py-2 text-white placeholder-gray-300 focus:outline-none focus:border-purple-400 transition"
      ...
      <input
        ...
        className="w-full mb-4 bg-transparent border-b border-gray-300/40 py-2 text-white placeholder-gray-300 focus:outline-none focus:border-pink-400 transition"
